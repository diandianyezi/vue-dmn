<template>
  <section class="dmn-edit">
    <div ref="dmnKie" class="dmn-kie" style="height: 800px;"></div>
    <div ref="dmn" class="card_bpmn__container" style="height: 800px"></div>
    <div
...
<dmn:definitions xmlns:dmn="http://www.omg.org/spec/DMN/20180521/MODEL/" xmlns="https://github.com/kiegroup/kie-dmn" xmlns:dc="http://www.omg.org/spec/DMN/20180521/DC/" xmlns:di="http://www.omg.org/spec/DMN/20180521/DI/" xmlns:dmndi="http://www.omg.org/spec/DMN/20180521/DMNDI/" xmlns:feel="http://www.omg.org/spec/DMN/20180521/FEEL/" xmlns:kie="http://www.drools.org/kie/dmn/1.2" id="0001-input-data-string" name="data-sum" typeLanguage="http://www.omg.org/spec/DMN/20180521/FEEL/" namespace="com.xiaomi.mifi">
  ...
  <dmndi:DMNDI>
    <dmndi:DMNDiagram id="_09AE9FE9-3FA4-4EFD-B95F-B9450F14EED3" name="DRG">
      ...
      // const res = await this.dmnEditor.canvas.getNodeIds();
      this.$nextTick(() => {
        this.dmnEditor.canvas.getNodeIds().then(res => {
          console.info('res', res)
        })
      })
      
      // this.dmnEditor.on('nodeRendered', (e) => {
      //   const node = e.node; // 获取节点引用
      //   // 应用自定义样式或修改背景
      //   console.info('节点信息', node)
      // });
    },
    async initDmn() {
